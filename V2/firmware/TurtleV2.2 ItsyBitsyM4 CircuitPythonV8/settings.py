...
DEBUG = True      # Print statements from turtle.py to console

if True: # settings for Itsy Robot Base Kit
    # robot specific parameters
    wheel_dia = 52.5     # mm (increase = decrease distance)
    wheel_base = 76.35  # mm (increase = spiral clockwise)
    ...
    leftLEDPin = board.D11
    emitterPin = board.D5

    rightDetectorPin = board.A3
    leftDetectorPin = board.A2
...
else: # pins for IstyBitsy M4 Breadboard Robot
    # robot specific parameters
