# Pinouts for RPi Pico Turtle Robot board
...
pwm = pwmio.PWMOut(board.GP6, frequency=50)

DEBUG = False
'''
# Pin assignments
rightEmitter = digitalio.DigitalInOut(board.GP20)
leftEmitter = digitalio.DigitalInOut(board.GP21)
leftLED = digitalio.DigitalInOut(board.GP26)
rightLED = digitalio.DigitalInOut(board.GP27)
button = digitalio.DigitalInOut(board.GP28)
rightDetector = AnalogIn(board.GP18)
leftDetector = AnalogIn(board.GP19)
...
Lstep0 = digitalio.DigitalInOut(board.GP5)
Lstep1 = digitalio.DigitalInOut(board.GP4)
Lstep2 = digitalio.DigitalInOut(board.GP3)
Lstep3 = digitalio.DigitalInOut(board.GP2)

Rstep0 = digitalio.DigitalInOut(board.GP13)
Rstep1 = digitalio.DigitalInOut(board.GP12)
Rstep2 = digitalio.DigitalInOut(board.GP11)
Rstep3 = digitalio.DigitalInOut(board.GP10)
